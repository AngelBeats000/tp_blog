<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\tp5\public/../application/index\view\article\article.html";i:1512570784;s:71:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\header.html";i:1530510279;s:70:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\right.html";i:1511441996;s:69:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\foot.html";i:1510399357;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>龙攀个人博客</title>
        <meta name="keywords" content="龙攀个人博客" />
        <meta name="description" content="龙攀个人博客" />
...
<div class="hotmenu">
    <div class="con">热门标签：
    <a href="http://localhost/grbkxt/index.php" target="_blank" style="color:#f00;">原版博客</a>
                ...
                <div class="xgread">
                    ...
                    <div class="rig">
                        <ul>
                            ...
                            <li>
                                <a href='<?php echo url('article/index',array('arid'=>$vo[0])); ?>' target="_blank"><?php echo $vo['1']; ?>
                                </a>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    ...
                    <ul>
                        ...
                        <li><div class="tu">
                            <a href='<?php echo url('article/index',array('arid'=>$vo['id'])); ?>' target="_blank">
                                <img src="<?php if($vo['pic'] != ''): ?>__IMG__<?php echo $vo['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?>" />
                            </a>
                            </div>
                            <p><a href='<?php echo url('article/index',array('arid'=>$vo['id'])); ?>'><?php echo $vo['title']; ?></a></p></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div id="bdcs"><div class="bdcs-container"><meta content="IE=9" http-equiv="x-ua-compatible">   <!-- 嵌入式 -->  <div id="default-searchbox" class="bdcs-main bdcs-clearfix">      
	...
	<form id="bdcs-search-form" autocomplete="off" class="bdcs-search-form" target="_blank" method="get" action="">       <input type="text" placeholder="请输入关键词" id="bdcs-search-form-input" class="bdcs-search-form-input" name="q" autocomplete="off" style="line-height: 30px; width:220px;">              <input type="submit" value="搜索" id="bdcs-search-form-submit" class="bdcs-search-form-submit bdcs-search-form-submit-magnifier">                       
	</form>      
