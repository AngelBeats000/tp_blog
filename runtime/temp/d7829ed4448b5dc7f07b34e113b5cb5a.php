<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpStudy\WWW\tp5\public/../application/index\view\index\index.html";i:1512570809;s:71:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\header.html";i:1530510279;s:70:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\right.html";i:1511441996;s:69:"D:\phpStudy\WWW\tp5\public/../application/index\view\common\foot.html";i:1510399357;}*/ ?>
	...
	<div class="left">
		<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				...
				<div class="pic"><a target="_blank" href="<?php echo url('article/index',array('arid'=>$vo['id'])); ?>">
					<img src="<?php if($vo['pic'] != ''): ?>__IMG__<?php echo $vo['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?>" alt="<?php echo $vo['title']; ?>" />
				</a></div>
				<div class="dec">
